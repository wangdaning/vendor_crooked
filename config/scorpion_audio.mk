#
# Scrorpion Audio Files
#

ALARM_PATH := vendor/scorpion/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/scorpion/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/scorpion/prebuilt/common/media/audio/ringtones
