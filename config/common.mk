...
PRODUCT_COPY_FILES += \
    vendor/scorpion/prebuilt/common/lib/libjni_latinime.so:system/lib/libjni_latinime.so \
    vendor/scorpion/prebuilt/common/lib/libjni_latinimegoogle.so:system/lib/libjni_latinimegoogle.so
else
PRODUCT_COPY_FILES += \
    vendor/scorpion/prebuilt/common/lib64/libjni_latinime.so:system/lib64/libjni_latinime.so \
    vendor/scorpion/prebuilt/common/lib64/libjni_latinimegoogle.so:system/lib64/libjni_latinimegoogle.so
endif
endif
